...
<textarea class="h-44 m-3 w-10/12 bg-slate-100 rounded-lg text-zinc-700 border-zinc-700 border-2 border-opacity-50 border-solid resize-none" placeholder="Add Your Comment" name="comment" id="comment"></textarea>
</div>
